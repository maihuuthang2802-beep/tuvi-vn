...
const modules = [
  ...
  { key: 'hopmenh', label: 'HỢP MỆNH', name: 'Hợp Mệnh', desc: 'Đối chiếu hai lá số', href: '/tu-vi/hop-menh', symbol: '◎', color: 'var(--color-tuvi)', bg: 'var(--color-tuvi-bg)', shadow: '0 0 24px rgba(201,169,110,0.25)' },
...
export default function ModuleCards() {
  return (
    <div className="mx-5 mt-6 grid grid-cols-2 gap-[14px] md:mx-auto md:max-w-[1100px] md:grid-cols-5">
      {modules.map((module) => (
